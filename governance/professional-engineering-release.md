...
权威范围：D01—D14 当前受控试点域。D14 只拥有编排、冲突升级和 owner 已批准边界内的姿态合成主权，不拥有专业裁决、资本批准或外部写入权。
...
工程门通过证明 D01—D14 的 L1—L3 工程建设完成，但不能推出真实经营有效、法律或税务意见、生产成熟度或外部写入许可。后续工作仅属于 L4：授权真实使用、成熟结果回放、阈值与权重校准、漂移评估和独立签署；L4 未通过不能被写成当前 L1—L3 工程失败。
