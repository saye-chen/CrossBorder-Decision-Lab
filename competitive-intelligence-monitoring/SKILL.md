...
与 CIDM、VLB、CIG、D07、D08、D09 的双向卡片统一读取 [skill-integration-protocol.md](references/skill-integration-protocol.md)。CIM 只拥有外部竞争事实、变化和归因主权；参与域失败时保留事实、归因降级，不以多数投票裁决。自动化和结构化数据读取 [data-contract-and-automation.md](references/data-contract-and-automation.md)。
