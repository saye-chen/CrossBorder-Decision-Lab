...
- 可以输出竞争维度的 `Test / Watch / Blocked`；最终投资 Go/No-Go 必须补齐需求、利润、合规、供应链和卖家能力，路由给 `category-investment-decision`。
...
8. **决策与路由**：输出 `Test / Watch / Blocked` 竞争姿态、反例、最弱假设、动作、风险、最小验证、成功/停止条件和复查日期；最终投资判断按边界路由。
