...
**D08 Runtime:** `D08-2026.07` (`controlled pilot`)
...
**Runtime:** `D08-2026.07` (`controlled pilot`)
...
| `platform-store-listing-conversion/` | D08 skill for cross-platform store, Listing, title, image-set, detail-page, landing-page, funnel, experiment, incident, migration, 8 output contracts, concrete optimization, and deterministic validation (`D08-2026.07`, controlled pilot) |
...
**D08 运行时：** `D08-2026.07`（`controlled pilot`）
...
**运行时：** `D08-2026.07`（`controlled pilot`）
...
| `platform-store-listing-conversion/` | D08 技能、全平台店铺与Listing、标题/主图/详情/落地页具体优化、12个平台专家卡、8类输出合同、100个语义场景、13类确定性工具与受控试点门（`D08-2026.07`，controlled pilot） |
