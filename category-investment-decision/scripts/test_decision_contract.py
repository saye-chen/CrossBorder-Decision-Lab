...
VERSIONS={CIDM:"CIDM-2026.07",VLB:"VLB-2026.07","competitive-intelligence-monitoring":"CIM-2026.07","consumer-insights-customer-growth":"CIG-2026.07","advertising-analysis-measurement-optimization":"AAMO-2026.07","logistics-inventory-fulfillment-decision":"LIFD-2026.07"}
...
def valid_payload() -> dict:
    return {
        ...
        "runtime_versions": {CIDM: "CIDM-2026.07", VLB: "VLB-2026.07"},
...
class OwnershipAndWriteBackTests(unittest.TestCase):
    ...
    def test_every_participant_must_report_success_or_failure(self):
        payload=valid_payload();payload["participating_skills"].append("logistics-inventory-fulfillment-decision");payload["runtime_versions"]["logistics-inventory-fulfillment-decision"]="LIFD-2026.07"
