...
def main():
    ...
    dump(OUT/"fixtures/evaluation-catalog.json",{"catalog_version":"PIPM-EVAL-2026.01","count":len(cases),"coverage":coverage,"cases":cases})
    bindings=[]
    for x in cases:
        bindings.append({
            "id":x["id"],
    ...
    dump(OUT/"fixtures/evaluation-execution-map.json",{"version":"PIPM-EXEC-2026.02","catalog":"evaluation-catalog.json","assertion_semantics":{"positive_per_case":2,"counterexample_per_case":2,"professional_engine_assertions":202,"decision_assertions":202,"total_assertions":404},"bindings":bindings})
