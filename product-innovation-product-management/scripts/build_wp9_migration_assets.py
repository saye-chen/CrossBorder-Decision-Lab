...
REPO=ROOT.parent
DOMAINS=[
("category-investment-decision","CIDM-2026.07",["product_opportunity","product_definition","product_version"],["capital_entry","portfolio_allocation"]),
("competitive-intelligence-monitoring","CIM-2026.07",["product_identity","specification","variant","claim_scope"],["competitor_identity","competitive_attribution"]),
("video-link-breakdown","VLB-2026.07",["product_fact","claim_allowed_use","use_context"],["creative_mechanism","content_expression"]),
("consumer-insights-customer-growth","CIG-2026.07",["product_version","target_user","user_job"],["customer_identity","retention","clv"]),
("advertising-analysis-measurement-optimization","AAMO-2026.07",["product_version","claim_allowed_use","product_change"],["account_structure","budget","bid"]),
("logistics-inventory-fulfillment-decision","LIFD-2026.07",["sku_variant","packaging","dimensions","weight","hazard_candidate"],["route","inventory","replenishment","fulfillment"]),
("platform-store-listing-conversion","PLCO-2026.07",["product_definition","specification","variant","claim","product_version"],["store","listing","offer_display","experiment"]),
...
("marketing-brand-campaign-management","MBCM-2026.07",["product_definition","positioning_constraint","claim","lifecycle"],["brand","gtm","campaign","offer_direction"]),
("pricing-profit-finance-cashflow-decision","PPFC-2026.07",["specification","material","packaging","variant","product_change"],["price","profit","cashflow"]),
("governance/erdg","ERDG-CONTRACT-2026.07",["contract","risk","state","lineage","impact_closure"],["structural_governance"])
]
...
def write_consumer_evidence(adapter):
 ...
 local={**adapter,"contract":"PIPM-CONSUMER-2026.07"}
...
def main():
 ...
 dump("consumer-adapters.json",{"contract":"PIPM-CONSUMER-2026.07","adapters":adapters,"external_write":False})
 ...
 dump("rollback-manifest.json",{"drill_id":"PIPM-RB-2026.07","status":"passed","release_units":[{"unit":x,"restore_hash":"sha256:"+h(x),"restored":True} for x in units],"legacy_reader_verified":True,"new_messages_audit_only":True,"external_write":False})
