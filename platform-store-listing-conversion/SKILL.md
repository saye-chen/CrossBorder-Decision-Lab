...
与 CIDM、CIM、VLB、CIG、D07、D09 的输入卡、允许/禁止用途、部分失败和冲突裁决读取 [skill-integration-protocol.md](references/skill-integration-protocol.md)。D08 只拥有页面承接主权；结构化数据读取 [data-contract-and-automation.md](references/data-contract-and-automation.md)。
