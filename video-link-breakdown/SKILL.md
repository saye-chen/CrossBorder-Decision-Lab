...
本 Skill 保留内容机制、脚本、镜头、素材组合、生产和传播判断主权。用户要求决定主图、图组、视频封面或详情素材在页面中的槽位、顺序、承接任务和转化实验时，路由 `platform-store-listing-conversion`；D08可产出页面级生产Brief，具体创意机制和素材生产继续由本 Skill 决定。
